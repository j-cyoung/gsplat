...
project_gaussians_2d_scale_rot_batch_forward = _make_lazy_cuda_func("project_gaussians_2d_scale_rot_batch_forward")
project_gaussians_2d_scale_rot_batch_backward = _make_lazy_cuda_func("project_gaussians_2d_scale_rot_batch_backward")
project_gaussians_2d_batch_forward = _make_lazy_cuda_func("project_gaussians_2d_batch_forward")
project_gaussians_2d_batch_backward = _make_lazy_cuda_func("project_gaussians_2d_batch_backward")
rasterize_batch_forward_sum = _make_lazy_cuda_func("rasterize_batch_forward_sum")
rasterize_batch_backward_sum = _make_lazy_cuda_func("rasterize_batch_backward_sum")
map_gaussian_to_intersects_batch = _make_lazy_cuda_func("map_gaussian_to_intersects_batch")
get_tile_bin_edges_batch = _make_lazy_cuda_func("get_tile_bin_edges_batch")